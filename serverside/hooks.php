...
function echoHook($hook) {
	echo("<tr class=\"property myDropdown dropdown".(array_key_exists("warning",$hook) && $hook["warning"] ? " warning" : "")."\">");
		echo("<td style=\"padding-top: 12px; padding-bottom: 8px;\">");
			echo("<div class=\"myDivDropdown\" style=\"cursor: pointer;\">
				<code style=\"font-size: 18px;\">".$hook["hook"]."</code>
				<div class=\"propertyButtonBlock btn-group\">
					<button type=\"button\" class=\"myButtonDropdown btn btn-default\"><span class=\"caret\"></span></button>
				</div>
			</div>");
